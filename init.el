...
(custom-set-variables
 ...
 '(package-selected-packages
   '(marginalia quasi-monochrome-theme sexy-monochrome-theme monochrome-theme eink-theme idle-highlight-mode idle-highlight rustic dap-go helm-lsp lsp-ui dap-mode lsp-mode go-mode modus-themes svg-lib npm geiser-guile geiser nano-theme zenburn-theme kaolin-themes solarized-theme company-jedi elpy pdf-tools elpher tide flycheck tern xref-js2 js2-refactor js2-mode helm-ag wgrep-helm wgrep which-key projectile-rails projectile-rails-global-mode yari rinari bundler ruby-compilation inf-ruby web-mode auctex magit :magit zygospore helm-gtags helm yasnippet ws-butler volatile-highlights use-package undo-tree iedit dtrt-indent counsel-projectile company clean-aindent-mode anzu)))
(custom-set-faces
